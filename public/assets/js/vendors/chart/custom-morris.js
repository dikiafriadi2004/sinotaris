...
new Morris.Line({ 
  ...
  lineColors:[CodexRohi.themeprimary,CodexRohi.themesecondary],
  xkey: 'year',
  ykeys: ['value1','value2'], 
...
Morris.Bar({
  ...
  barColors:[CodexRohi.themeprimary,CodexRohi.themesecondary],
  xkey: 'y',
  ykeys: ['valuea', 'valueb'],
  labels: ['Series A', 'Series B']
});
...
Morris.Donut({
  ...
  colors:[CodexRohi.themeprimary,CodexRohi.themesecondary,CodexRohi.themewarning,CodexRohi.themeinfo]
});
