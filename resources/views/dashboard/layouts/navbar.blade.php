                    ...
                    <div class="hover-dropdown navshop-drop">
                        ...
                        <ul data-simplebar>
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="assets/images/ecom-dashboard/small-pro/1.jpg" alt=""></div>
                                        <div class="media-body">
                                            <h6>teddy bear</h6><span class="text-light">$250</span>
                                        </div>
                                        <div class="close-pro"><i class="ti-trash fs-6"></i></div>
                                    </div>
                                </a></li>
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="assets/images/ecom-dashboard/small-pro/2.jpg" alt=""></div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="assets/images/ecom-dashboard/small-pro/3.jpg" alt="">
                                        </div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="assets/images/ecom-dashboard/small-pro/4.jpg" alt="">
                                        </div>
                                        <div class="media-body">
                            ...
                            <li><a href="#!">
                                    <div class="media">
                                        <div class="img-wrap"><img class="img-fluid"
                                                src="assets/images/ecom-dashboard/small-pro/5.jpg" alt="">
                                        </div>
                                        <div class="media-body">
                                            <h6>iphone</h6><span class="text-light">$140</span>
                                        </div>
