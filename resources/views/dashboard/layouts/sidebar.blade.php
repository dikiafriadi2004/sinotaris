<aside class="codex-sidebar">
    <div class="logo-gridwrap codex-brand"><a class="codexbrand-logo d-flex" href="index.html"><img class="img-fluid"
                src="{{ asset('assets/images/logo/logo.png') }}" alt="theeme-logo"><span
    ...
    <div class="codex-menuwrapper">
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <li class="menu-item"><a href="{{ route('notaris.index') }}">
                    <div class="icon-item"><i data-feather="users"></i></div><span>Data Notaris</span>
                </a></li>
        </ul>
    </div>
</aside>
