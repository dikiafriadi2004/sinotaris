...
// Report
Route::get('/ppat/add/report/{ppat:slug}', [ReportController::class, 'create'])->name('report.create');
Route::post('/ppat/add/report/{ppat:slug}/store', [ReportController::class, 'store'])->name('report.store');
